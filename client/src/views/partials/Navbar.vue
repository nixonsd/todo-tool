        ...
        <nav>
            <div class="nav-wrapper red darken-1">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="https://github.com/nixonsd/todo-tool"><i class="small material-icons left">insert_link</i>GitHub</a></li>
                </ul>
            </div>
            ...
            <ul class="sidenav" id="mobile-demo">
                ...
                <li><a class="sidenav-close" href="https://github.com/nixonsd/todo-tool"><i class="small material-icons left">insert_link</i>GitHub</a></li>
            </ul>
        </nav>
    </div>
</template>
